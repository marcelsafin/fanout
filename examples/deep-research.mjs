...
const SEARCH_PROMPT = (angle) =>
  ...
  "## Task\nSearch the web for the query above (or a refined version) using your web search capability; if you lack a dedicated search tool, fetch a search engine results page via your fetch or bash tools. Return the top 4-6 most relevant results.\n" +
...
const FETCH_PROMPT = (source, angle) =>
  ...
  "## Task\n1. Retrieve the page content with your web/fetch tool (fallback: bash `curl -sL`).\n" +
